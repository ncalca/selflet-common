 ...
 * $Id$
 */
package it.polimi.elet.selflet.behaviorParser.selfletbehavior.impl;
...
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Complex;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Condition;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Elementary;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.FileReference;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Final;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Init;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Intermediate;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Invocation;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Selflet;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.SelfletbehaviorFactory;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.SelfletbehaviorPackage;
import it.polimi.elet.selflet.behaviorParser.selfletbehavior.Service;
...
public class SelfletbehaviorPackageImpl extends EPackageImpl implements SelfletbehaviorPackage {
	 ...
	 * @see it.polimi.elet.selflet.behaviorParser.selfletbehavior.SelfletbehaviorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * {@link SelfletbehaviorPackage#eINSTANCE} when that field is accessed.
	...
	public static SelfletbehaviorPackage init() {
		if (isInited)
			return (SelfletbehaviorPackage) EPackage.Registry.INSTANCE.getEPackage(SelfletbehaviorPackage.eNS_URI);

		// Obtain or create and register package
		SelfletbehaviorPackageImpl theSelfletbehaviorPackage = (SelfletbehaviorPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SelfletbehaviorPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new SelfletbehaviorPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBehavior_Name(), ecorePackage.getEString(), "name", null, 0, 1, Behavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavior_State(), this.getState(), this.getState_TargetBehavior(), "state", null, 0, -1, Behavior.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavior_TargetService(), this.getService(), this.getService_Behavior(), "targetService", null, 0, 1, Behavior.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(stateEClass, State.class, "State", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getState_Action(), this.getAction(), this.getAction_TargetState(), "action", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getState_Name(), ecorePackage.getEString(), "name", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_Next(), this.getCondition(), null, "next", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_TargetBehavior(), this.getBehavior(), this.getBehavior_State(), "targetBehavior", null, 0, 1, State.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSelflet_Service(), this.getService(), null, "service", null, 0, -1, Selflet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceEClass, Service.class, "Service", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getService_Behavior(), this.getBehavior(), this.getBehavior_TargetService(), "behavior", null, 0, -1, Service.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getService_Name(), ecorePackage.getEString(), "name", null, 0, 1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getService_Description(), ecorePackage.getEString(), "description", null, 0, 1, Service.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(conditionEClass, Condition.class, "Condition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCondition_Body(), ecorePackage.getEString(), "body", null, 0, 1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCondition_ConditionFile(), ecorePackage.getEString(), "conditionFile", null, 0, 1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCondition_TargetState(), this.getState(), null, "targetState", null, 0, 1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(actionEClass, Action.class, "Action", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAction_Body(), ecorePackage.getEString(), "body", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAction_ActionFile(), ecorePackage.getEString(), "actionFile", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAction_AbilityFile(), this.getFileReference(), "abilityFile", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_TargetState(), this.getState(), this.getState_Action(), "targetState", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
