...
public interface SelfletbehaviorFactory extends EFactory {
	 ...
	 * @generated
	 */
	SelfletbehaviorFactory eINSTANCE = it.polimi.elet.selflet.behaviorParser.selfletbehavior.impl.SelfletbehaviorFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Init</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Final</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Invocation</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Elementary</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Complex</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Selflet</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
