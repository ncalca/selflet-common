 ...
 * <ul>
 * <li>
 * {@link it.polimi.elet.selflet.behaviorParser.selfletbehavior.impl.BehaviorImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link it.polimi.elet.selflet.behaviorParser.selfletbehavior.impl.BehaviorImpl#getState
 * <em>State</em>}</li>
 * <li>
 * {@link it.polimi.elet.selflet.behaviorParser.selfletbehavior.impl.BehaviorImpl#getTargetService
...
public class BehaviorImpl extends EObjectImpl implements Behavior {
	...
	public EList<State> getState() {
		if (state == null) {
			state = new EObjectContainmentWithInverseEList<State>(State.class, this, SelfletbehaviorPackage.BEHAVIOR__STATE,
					SelfletbehaviorPackage.STATE__TARGET_BEHAVIOR);
		}
		return state;
	}
	...
	public Service getTargetService() {
		if (eContainerFeatureID() != SelfletbehaviorPackage.BEHAVIOR__TARGET_SERVICE)
			return null;
